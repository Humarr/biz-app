  ...
  return (
    <section className="section-py bg-background">
      <div className="container-narrow text-center">
        <h1 className="text-primary font-headline2 uppercase mb-6">
        ...
        <h2 className="text-3xl font-headline2 uppercase text-accent mb-4">
          This isn't a pep talk.
        </h2>
        <h3 className="text-4xl font-headline2 uppercase text-primary">
