...
export default function SalesPage() {
  return (
    <div className="bg-white text-gray-900 font-sans">
      <Head>
        <title>Don't Start a Business Until You Read This 37-Page Rant</title>
        <meta name="description" content="How to start a business that attracts paying strangers - even if you don't know what to sell" />
      </Head>

      {/* Hero Section */}
      <section className="relative py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-50 to-red-50">
            ...
            <div className="p-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                <div className="bg-white bg-opacity-10 p-4 rounded-lg">
                  <p className="font-bold text-red-700">❌ Posting and praying...</p>
                </div>
                <div className="bg-white bg-opacity-10 p-4 rounded-lg">
                  <p className="font-bold text-green-700">✅ Attracting total strangers who wanted to buy — without me chasing them.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-center">Real People. Real Broke. Real Wins.</h2>
          
          <div className="space-y-6">
            {[
              {
                quote: "I used the ₦4,500 playbook to fix my entire offer… I made my first ₦63k in 6 days. It didn't feel real until someone sent money before I even replied them.",
                author: "Tobi A., Lagos (student-turned-copywriter)"
              },
              {
                quote: "I used to think I had to sell fast-moving products to make money. This rant showed me how to sell what I already knew. Now I run an editing service and charge ₦15k per script.",
                author: "Kelechi M., Enugu (ex-reseller)"
              },
              {
                quote: "I was going to give up and go back to job hunting. This thing opened my eyes to how I'd been thinking like a slave. I've made over ₦220k from a service I didn't know I could charge for.",
                author: "Faridah R., Abuja (introvert + self-taught designer)"
              },
              {
                quote: "I stopped calling myself 'just a student.' That alone changed everything. I started charging ₦7k for a 30-min consult. Now people book me to help them write proposals.",
                author: "Victor A., Ibadan (UNN dropout)"
              }
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8 text-center">You Don't Trust Testimonials? Good. Let's Get Cold.</h2>
          
          <div className="space-y-6">
            {[
              "90% of Nigerians who start a 'business' never make it past month 3. (Source: SMEDAN/NBS survey, 2023)",
              "Most failed businesses don't die because of 'low capital' — they die because of zero understanding of how money flows. (Source: African Development Bank's Youth Enterprise Report)",
              "The number one skill needed to escape poverty in Nigeria is not tech or trading — it's the ability to sell. — Tayo Oyedeji, CEO of Overwood Capital",
              "3 out of 4 freelancers in Nigeria still make less than ₦50k per month. Why? Because they're stuck competing on price, not offers. (Source: Payoneer Global Freelancer Report)"
            ].map((stat, index) => (
              <div key={index} className="flex items-start bg-white p-4 rounded-lg shadow-sm">
                <span className="mr-2 mt-1">•</span>
                <span>{stat}</span>
          ...
          <div className="p-6 bg-blue-50 rounded-lg border-l-4 border-blue-500 mt-10">
            <p className="font-bold">Bottom line?</p>
            <p>You're not the only one who's been confused, broke, and overwhelmed. These people were, too.</p>
            <p className="mt-2 font-bold">They didn't "hustle harder." They just got clarity — and applied the right steps.</p>
            <p className="mt-2 font-bold text-blue-700">Same ones you're about to read in this brutal, business-saving ebook.</p>
          </div>
        </div>
      </section>
