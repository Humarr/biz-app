    ...
    return (
      <div className="bg-[#f7f7f7] min-h-screen py-8 px-4">
        <div className="max-w-3xl mx-auto bg-white p-6 md:p-8 shadow-lg">
          ...
          <p className="mb-4">
            You've bookmarked 47 different business articles, saved 23 "business ideas" posts on Instagram, and joined 8 different "entrepreneur" WhatsApp groups... but you're still exactly where you were 2 years ago.
          </p>
          
          <p className="mb-4 font-bold">Still working the same job.</p>
          <p className="mb-4 font-bold">Still struggling with the same money problems.</p>
          <p className="mb-4 font-bold">Still dreaming about "someday" starting that business.</p>
          ...
          <p className="mb-4">
            Not just the money (though we'll get to that). I'm talking about the real cost. The hidden price you're paying every single day you remain trapped in this cycle.
          </p>
          
          <p className="font-bold mb-4">Think about your dreams...</p>
          ...
          <p className="mb-4">
            You probably told yourself it was temporary. Just until you figured things out. Just until you saved enough money to start that business. Just until you got more experience.
          </p>
          
          <p className="font-bold mb-4">How many years ago was that?</p>
          ...
          <p className="font-bold mb-4">But let's talk about the money too, because the numbers are shocking...</p>
          ...
          <p className="font-bold mb-4">Why? Because they have financial stability to make smart decisions instead of desperate ones.</p>
          
          <p className="mb-4 italic">
            Robert Kiyosaki, author of Rich Dad Poor Dad, put it perfectly: "The poor and middle class work for money. The rich have money work for them."
          </p>
          ...
          <p className="mb-4 italic">
            Even Oprah Winfrey said: "The biggest adventure you can take is to live the life of your dreams."
          </p>
          ...
          <ul className="list-disc pl-5 mb-8 space-y-4">
            ...
            <li>Why 87% of Nigerian businesses fail before they even start (The shocking reason has nothing to do with capital, location, or competition 
                {/* <br/><br/> */}
                
                - once you know this, you'll spot doomed businesses from miles away) - Page 15</li>

            <li>The sneaky methods big corporations use to keep you trapped in salary dependency
            {/* <br/><br/> */}
                 (They don't want you to know these 3 psychological tricks that keep employees from ever becoming entrepreneurs) - Page 41</li>

            <li>What never to do when starting a side business <br/><br/>(If you make this one mistake, your boss will find out within 2 weeks - and you might lose your job) - Page 47</li>
          </ul>
          ...
          <p className="text-center font-bold mb-4">So the question isn't whether this system will work for you.</p>
          ...
          <div className="border-2 border-black p-4 mb-8">
            ...
            <p className="font-bold">That's it! Simple, secure, and you're dealing directly with us.</p>
          </div>
