    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="text-lg leading-relaxed space-y-6">
          <p>It&apos;s 11:47 PM on a Tuesday night.</p>
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="mt-12 bg-green-50 border-l-4 border-green-400 p-6 text-center">
          ...
          <p className="text-4xl font-bold mt-4">Just ₦8,500.</p>
        ...
        <div className="mt-12 text-center space-y-4 text-lg">
          ...
          <p className="text-xl font-semibold">
            ₦8,500 for the complete playbook + both bonuses + lifetime access to
            the PDF.
          </p>
        </div>
        ...
        <div className="mt-12 bg-yellow-50 border-l-4 border-yellow-400 p-6">
          ...
          <p className="mt-4 text-lg font-semibold">
            So I priced this at ₦8,500 because I want YOU to be able to afford
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-lg">
          ...
          <p>
            <strong>Step 2:</strong> Pay ₦8,500 securely via Paystack (they
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 mt-2">
                Or you could spend ₦8,500 and get the complete system in one
                weekend.
              </p>
              <p className="text-gray-700 mt-2">
            ...
            <div>
              ...
              <p className="text-gray-700 mt-2">
                ...
                worth ₦8,500? You shouldn&apos;t have to keep it.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-lg">
          <p>
            But here&apos;s the thing: ₦8,500 is less than what most people
        ...
        <div className="mt-12 bg-red-50 border-l-4 border-red-400 p-6">
          ...
          <p className="text-xl font-bold mt-4">
            If you can&apos;t find ₦8,500 to invest in knowledge that could
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              "I've spent over ₦80,000 on business courses in the past 2 years. This ₦8,500 e-book taught me more than all of them combined. I'm not even exaggerating. — Amarachi P., Asaba",
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="mt-12 space-y-6 text-lg">
          ...
          <p>
            You know ₦8,500 is not a lot of money for something that could
            change your financial situation.
          </p>
          <p>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-lg mb-4">Pay ₦8,500.</p>
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="mt-12 space-y-6 text-lg">
          ...
          <p>
            The decision to invest ₦8,500 in yourself instead of spending it on
