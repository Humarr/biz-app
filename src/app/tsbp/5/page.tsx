    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="mt-12 bg-green-50 border-l-4 border-green-400 p-6 text-center">
          ...
          <p className="text-4xl font-bold mt-4">Just ₦5450.</p>
        ...
        <div className="mt-12 text-center space-y-4 text-lg">
          ...
          <p className="text-xl font-semibold">
            ₦5450 for the complete playbook + both bonuses + lifetime access to
            the PDF.
          </p>
        </div>
        ...
        <div className="mt-12 bg-yellow-50 border-l-4 border-yellow-400 p-6">
          ...
          <p className="mt-4 text-lg font-semibold">
            So I priced this at ₦5450 because I want YOU to be able to afford
        ...
        <div className="mt-12 space-y-6 text-lg">
          ...
          <p className="text-xl font-semibold">
            ₦5450 will look like the best money you&apos;ve ever spent.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-16 bg-blue-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-white p-8 rounded-lg shadow-sm border border-gray-200 text-center">
            ...
            <p className="text-lg mb-6">
              Buy The Small Business Playbook today for ₦5450.
            </p>
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-lg">
          ...
          <p>
            <strong>Step 2:</strong> Pay ₦5450 securely via Paystack (they
        ...
        <div className="mt-12 text-center">
          ...
          <div className="bg-blue-600 text-white p-8 rounded-lg">
            <h3 className="text-2xl font-bold mb-4">
              GET THE SMALL BUSINESS PLAYBOOK FOR ₦5450
            </h3>
            <p className="mb-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 mt-2">
                Or you could spend ₦5450 and get the complete system in one
                weekend.
              </p>
              <p className="text-gray-700 mt-2">
            ...
            <div>
              ...
              <p className="text-gray-700 mt-2">
                ...
                worth ₦5450? You shouldn&apos;t have to keep it.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-lg">
          <p>
            But here&apos;s the thing: ₦5450 is less than what most people
        ...
        <div className="mt-12 bg-red-50 border-l-4 border-red-400 p-6">
          ...
          <p className="text-xl font-bold mt-4">
            If you can&apos;t find ₦5450 to invest in knowledge that could
        ...
        <div className="mt-12 space-y-6 text-lg">
          ...
          <p className="text-xl font-semibold">
            Find the ₦5450. Get the playbook. Start building.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              "I've spent over ₦80,000 on business courses in the past 2 years. This ₦5450 e-book taught me more than all of them combined. I'm not even exaggerating. — Amarachi P., Asaba",
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="mt-12 space-y-6 text-lg">
          ...
          <p>
            You know ₦5450 is not a lot of money for something that could
            change your financial situation.
          </p>
          <p>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-lg mb-4">Pay ₦5450.</p>
      ...
      <section className="px-4 py-16 bg-green-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            GET THE SMALL BUSINESS PLAYBOOK NOW FOR ₦5450
          </h2>
      ...
      <section className="px-4 py-16 max-w-4xl mx-auto">
        ...
        <div className="mt-12 space-y-6 text-lg">
          ...
          <p>
            The decision to invest ₦5450 in yourself instead of spending it on
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="text-center">
                ...
                <p className="text-xl font-bold">₦5450</p>
              </div>
              <div className="text-center">
