...
export default function SalesLetter() {
  return (
    <main className="bg-gray-50 text-black min-h-screen py-12 font-serif">
      <section className="max-w-3xl mx-auto px-4 sm:px-6">
        <p className="my-6 leading-relaxed">
          If you knew the <span className="font-bold">TRUE REASON</span> why most employees stay broke...you’d <span className="italic">NEVER</span> see your job the same way again.
        </p>
        <p className="my-6 leading-relaxed">
          <span className="underline">NEW research shows:</span>
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8 text-red-600">
          THE "SECRET PLAYBOOK" THAT REVEALS HOW TO START A PROFITABLE SIDE BUSINESS WITHOUT RISKING YOUR JOB OR SAVINGS!
        </h2>
        <p className="my-6 leading-relaxed">
          And now you can use this to add <span className="font-bold">₦50,000-₦200,000 monthly</span> to your income in the next 90 days!
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <ul className="list-disc list-inside ml-4 my-6">
          ...
          <li>You're terrified of losing your current job</li>
        </ul>
        <p className="my-6 leading-relaxed">
          Dear Friend,
        </p>
        ...
        <p className="my-6 leading-relaxed">
          You've downloaded dozens of "make money online" PDFs, watched countless YouTube videos about entrepreneurship…
        </p>
        <p className="my-6 leading-relaxed">
          …perhaps even bought several business courses, but the truth is you just can't seem to take that first step (or stick with it when you do start).
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
          Perhaps you're even feeling a little disgusted with yourself and your inability to escape the salary trap that keeps you broke every month.
        </h2>
        <p className="my-6 leading-relaxed">
          You feel like no matter what business idea you research, it's not going to work for someone like you.
        </p>
        <p className="my-6 leading-relaxed">
          You've told yourself you'll "start next month" so many times that the phrase has lost all meaning.
        </p>
        <p className="my-6 leading-relaxed">
          You've bookmarked 47 different business articles, saved 23 "business ideas" posts on Instagram, and joined 8 different "entrepreneur" WhatsApp groups...
        </p>
        <p className="my-6 leading-relaxed">
          but you're still exactly where you were 2 years ago.
        </p>
        <p className="my-6 leading-relaxed">
          Still working the same job.
        </p>
        <p className="my-6 leading-relaxed">
          Still struggling with the same money problems.
        </p>
        <p className="my-6 leading-relaxed">
          Still dreaming about "someday" starting that business.
        </p>
        <p className="my-6 leading-relaxed">
          Maybe you've even tried to start something before.
        </p>
        <p className="my-6 leading-relaxed">
          Maybe you registered a business name that you never used.
        </p>
        <p className="my-6 leading-relaxed">
          Maybe you bought products to resell but they're still sitting in your room.
        </p>
        <p className="my-6 leading-relaxed">
          Maybe you started a blog or social media page that you abandoned after two weeks.
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8 text-red-600 border-2 border-gray-300 p-4">
          And now you're starting to wonder if you're just not "business material…"
        </h2>
        <p className="my-6 leading-relaxed">
          If maybe you're meant to be an employee forever…
        </p>
        <p className="my-6 leading-relaxed">
          If financial freedom is something that happens to other people, but not people like you…
        </p>
        <p className="my-6 leading-relaxed">
          If any of this sounds familiar, then what I'm about to tell you will change everything...
        </p>
        <p className="my-6 leading-relaxed">
          But first, let me ask you to do something that might be uncomfortable.
        </p>
        <p className="my-6 leading-relaxed">
          I need you to really think about what it's costing you to stay where you are right now.
        </p>
        <p className="my-6 leading-relaxed">
          Not just the money (though we'll get to that). I'm talking about the <span className="font-bold">real cost</span>. The hidden price you're paying every single day you remain trapped in this cycle.
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
          Think about your dreams...
        </h2>
        <p className="my-6 leading-relaxed">
          Remember when you first got your job?
        </p>
        <p className="my-6 leading-relaxed">
          You probably told yourself it was temporary. Just until you figured things out.
        </p>
        <p className="my-6 leading-relaxed">
          Just until you saved enough money to start that business. Just until you got more experience.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Are they still as vivid and exciting as they were back then?
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Every year you spend in that job is a year closer to 40, 50, 60... still working for someone else's dream while your own dreams collect dust.
        </p>
        <p className="my-6 leading-relaxed">
          Every month you tell yourself "I'll start next month" is another month your younger, more energetic competitors are building the businesses you keep thinking about.
        </p>
        <p className="my-6 leading-relaxed">
          But let's talk about the money too, because the numbers are shocking...
        </p>
        <p className="my-6 leading-relaxed">
          Take out your phone calculator right now and do this simple exercise:
        </p>
        <p className="my-6 leading-relaxed">
          Write down your current monthly salary. Let's say it's ₦180,000.
        </p>
        <p className="my-6 leading-relaxed">
          Now write down what you'd like to be making monthly if you had a successful side business.
        </p>
        <p className="my-6 leading-relaxed">
          Let's be conservative and say ₦350,000 (₦180,000 salary plus ₦170,000 from business).
        </p>
        <p className="my-6 leading-relaxed">
          The difference? ₦170,000 monthly.
        </p>
        <p className="my-6 leading-relaxed">
          That means every month you don't start your business, you're essentially losing ₦170,000 every month.
        </p>
        <p className="my-6 leading-relaxed">
          Every year? That's over ₦2 million naira you're leaving on the table.
        </p>
        <p className="my-6 leading-relaxed">
          In 5 years? That's ₦10 million naira in missed opportunity.
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
          But the real cost goes deeper than money...
        </h2>
        <p className="my-6 leading-relaxed">
          What about the respect you're not getting because people still see you as "just an employee"?
        </p>
        <p className="my-6 leading-relaxed">
          What about the confidence you're not building because you've never proven to yourself that you can create something from nothing?
        </p>
        <p className="my-6 leading-relaxed">
          What about the example you're not setting for your children - that you have to work for others your entire life instead of building something of your own?
        </p>
        <p className="my-6 leading-relaxed">
          What about the sleepless nights worrying about job security, about whether your company will downsize, about what happens if you get sick and can't work?
        </p>
        <p className="my-6 leading-relaxed">
          What about the dreams your spouse has that you can't fulfill because you're limited by one salary?
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          They're taking the customers you could have had.
        </p>
        <p className="my-6 leading-relaxed">
          They're making the money you could have made.
        </p>
        <p className="my-6 leading-relaxed">
          They're living the life you could be living.
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
          Right now, as you read this, someone just started the business you've been thinking about for months.
        </h2>
        <p className="my-6 leading-relaxed">
          Someone just made their first sale from their business.
        </p>
        <p className="my-6 leading-relaxed">
          Someone just made their first ₦50,000 while you're still "planning."
        </p>
        <p className="my-6 leading-relaxed">
          The window of opportunity doesn't stay open forever.
        </p>
        <p className="my-6 leading-relaxed">
          But here's what gives me hope for you...
        </p>
        <p className="my-6 leading-relaxed">
          The fact that you're still reading this tells me something important. It tells me you haven't given up.
        </p>
        <p className="my-6 leading-relaxed">
          Deep down, you still believe you can have more. You still believe you deserve better.
        </p>
        <p className="my-6 leading-relaxed">
          And you're right.
        </p>
        ...
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8 text-red-600 border-2 border-gray-300 p-4">
          I held my phone tightly in my sweaty palm as I stared at my bank balance showing ₦4,500.
        </h2>
        <p className="my-6 leading-relaxed">
          Rent was due in 3 days. ₦450,000.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Those were my uncle's exact words at my cousin's wedding just two weeks before. The whole family heard it. I wanted to disappear.
        </p>
        <p className="my-6 leading-relaxed">
          But you see, this wasn't the first time I felt this shame...
        </p>
        <p className="my-6 leading-relaxed">
          In fact, I'd been thinking about starting a business for over 3 years. Every month, same story.
        </p>
        <p className="my-6 leading-relaxed">
          Check Instagram, see my classmates posting their new cars, new apartments, business openings.
        </p>
        <p className="my-6 leading-relaxed">
          Then check my account balance and feel like a complete failure.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <ul className="list-disc list-inside ml-4 my-6">
          <li>"What if I lose the little money I have?"</li>
          <li>"What if my boss finds out and fires me?"</li>
          <li>"What if my girlfriend thinks I'm being foolish?"</li>
          <li>"What if I fail and everyone laughs at me?"</li>
        </ul>
        <p className="my-6 leading-relaxed">
          So I stayed stuck. Dreaming about financial freedom while living paycheck to paycheck.
        </p>
        <p className="my-6 leading-relaxed">
          Watching my younger colleagues get promoted while I remained in the same position for 4 years.
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
          But that phone call changed everything...
        </h2>
        <p className="my-6 leading-relaxed">
          You see, it was my bank calling to inform me that my account would be closed for insufficient funds.
        </p>
        <p className="my-6 leading-relaxed">
          ₦4,500 for a whole month's expenses? I was officially broke.
        </p>
        <p className="my-6 leading-relaxed">
          That night, I couldn't sleep. I kept thinking: "At what point did my life become this predictable cycle of suffering?"
        </p>
        <p className="my-6 leading-relaxed">
          Wake up at 5am. Fight Lagos traffic for 2 hours. Work for someone else's dream for 9 hours. Fight traffic again for 2 hours. Get home exhausted. Repeat tomorrow.
        </p>
        <p className="my-6 leading-relaxed">
          For what? To barely survive while my mates were thriving?
        </p>
        <p className="my-6 leading-relaxed">
          I was fed up. Completely finished.
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8 text-red-600">
        ...
        <p className="my-6 leading-relaxed">
          These guys were younger than me. Had less experience than me.
        </p>
        <p className="my-6 leading-relaxed">
          But they were making more money in their "spare time" than I was making from my full-time job!
        </p>
        <p className="my-6 leading-relaxed">
          Sounds unbelievable, right?
        </p>
        <p className="my-6 leading-relaxed">
          That's exactly what I thought. Until I saw their bank statements.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          "What system?" I asked desperately.
        </p>
        <p className="my-6 leading-relaxed">
          He pulled out his phone and showed me a step-by-step playbook.
        </p>
        <p className="my-6 leading-relaxed">
          Nothing fancy. No complicated theories.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
          Wait, what? A business system that actually worked without massive risk or startup capital?
        </h2>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Six months later, ₦180,000.
        </p>
        <p className="my-6 leading-relaxed">
          Today, I make more from my "side hustle" than my main job, and I've helped over 200 other employed Nigerians do the same.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          The system I discovered was so simple, I could have started it 5 years ago if someone had just shown me the right steps.
        </p>
        <p className="my-6 leading-relaxed">
          You see, the problem was never that I wasn't smart enough or didn't have good ideas...
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          But first, who the heck am I to be writing to you about business success?
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Warren Buffett, the world's most successful investor, once said: <span className="italic">"Someone's sitting in the shade today because someone planted a tree a long time ago."</span>
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Wait, what? You mean most successful entrepreneurs didn't quit their jobs and risk everything?
        </p>
        <p className="my-6 leading-relaxed">
          Exactly!
        </p>
        ...
        <p className="my-6 leading-relaxed">
          Richard Branson, founder of Virgin Group, said: <span className="italic">"Business opportunities are like buses, there's always another one coming."</span>
        </p>
        <p className="my-6 leading-relaxed">
          The fact is, I had been waiting for the "perfect" opportunity instead of starting with what was already available to me.
        </p>
        <p className="my-6 leading-relaxed">
          You see, even in Nigeria, the statistics are encouraging...
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Stick with me here, because this gets even better...
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Why? Because they have financial stability to make smart decisions instead of desperate ones.
        </p>
        <p className="my-6 leading-relaxed">
          Robert Kiyosaki, author of Rich Dad Poor Dad, put it perfectly: <span className="italic">"The poor and middle class work for money. The rich have money work for them."</span>
        </p>
        <p className="my-6 leading-relaxed">
          But wait, there's more...
        </p>
        <p className="my-6 leading-relaxed">
          You know what the Central Bank of Nigeria reported last year? That the average Nigerian saves only 2.4% of their income.
        </p>
        <p className="my-6 leading-relaxed">
          Meanwhile, inflation is eating away at whatever little we manage to save.
        </p>
        <p className="my-6 leading-relaxed">
          The math is simple - if you're not creating additional income streams, you're actually getting poorer every year.
        </p>
        <p className="my-6 leading-relaxed">
          Even Oprah Winfrey said: <span className="italic">"The biggest adventure you can take is to live the life of your dreams."</span>
        </p>
        <p className="my-6 leading-relaxed">
          But how can you live your dreams when you're trapped in a cycle of barely surviving?
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
          Here's what really convinced me though...
        </h2>
        <p className="my-6 leading-relaxed">
          Jeff Bezos didn't start Amazon in his garage because he was broke.
        </p>
        <p className="my-6 leading-relaxed">
          He started it while working at a hedge fund, making excellent money.
        </p>
        <p className="my-6 leading-relaxed">
          But he knew that staying "safe" was actually the riskiest thing he could do.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8 text-red-600">
          You see, I realized that all the successful people weren't just lucky or more talented...
        </h2>
        <p className="my-6 leading-relaxed">
          They simply understood something I was missing: that the biggest risk isn't starting a side business... it's NOT starting one.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          There's still more waiting inside...
        </p>
        <ul className="list-disc list-inside ml-4 my-6">
        ...
        <p className="my-6 leading-relaxed">
          But let's be even more conservative...
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Think about what ₦600,000 could do for your life:
        </p>
        <ul className="list-disc list-inside ml-4 my-6">
          ...
          <li>Help your parents without struggling</li>
          <li>Actually have money left over at month-end</li>
        </ul>
        <p className="my-6 leading-relaxed">
          Now, if I told you that a business consultant would charge you at least ₦500,000 to create a personalized business plan for you...
        </p>
        <p className="my-6 leading-relaxed">
          And if I mentioned that attending a 2-day business seminar in Lagos costs between ₦150,000 - ₦300,000...
        </p>
        <p className="my-6 leading-relaxed">
          And if you knew that most business courses online cost between ₦100,000 - ₦250,000...
        </p>
        <p className="my-6 leading-relaxed">
          You'd probably think this complete playbook - with everything I've just shown you - would cost at least ₦100,000, right?
        </p>
        <p className="my-6 leading-relaxed">
          After all, this isn't just theory.
        </p>
        <p className="my-6 leading-relaxed">
          These are the exact methods that have helped over 200 employed Nigerians build profitable side businesses worth millions of naira combined.
        </p>
        <p className="my-6 leading-relaxed">
          Some people have told me I should charge ₦150,000 for this system.
        </p>
        <p className="my-6 leading-relaxed">
          Others said ₦200,000 would be fair given the life-changing results.
        </p>
        <p className="my-6 leading-relaxed">
          But you see, I remember what it felt like to have only ₦4,500 in my account with rent due in 3 days...
        </p>
        <p className="my-6 leading-relaxed">
          I remember the shame of borrowing transport money...
        </p>
        <p className="my-6 leading-relaxed">
          I remember watching my mates succeed while I stayed stuck...
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
        ...
        <p className="my-6 leading-relaxed">
          That's less than what most people spend on data and airtime in a month!
        </p>
        <p className="my-6 leading-relaxed">
          Let me put this in perspective for you...
        </p>
        <p className="my-6 leading-relaxed">
          ₦5,250 is what you might spend on lunch for one day.
        </p>
        <p className="my-6 leading-relaxed">
          But this playbook could generate ₦50,000+ monthly for years to come.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Of course you would. That's like giving me ₦5 so I can hand you ₦50 in return.
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8 text-red-600 border-2 border-gray-300 p-4">
        ...
        <p className="my-6 leading-relaxed">
          You're probably wondering: "This sounds too good to be true. What if it doesn't work for me? What if I'm different? What if I waste my ₦5,250?"
        </p>
        <p className="my-6 leading-relaxed">
          I get it. I really do.
        </p>
        <p className="my-6 leading-relaxed">
          You've probably been burned before by promises that didn't deliver.
        </p>
        <p className="my-6 leading-relaxed">
          Maybe you bought a course that was full of theory but no practical steps.
        </p>
        <p className="my-6 leading-relaxed">
          Maybe you tried some "make money online" scheme that turned out to be a scam.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          Once you download this playbook, I can't get it back from you.
        </p>
        <p className="my-6 leading-relaxed">
          The information will be on your phone, your laptop, your brain.
        </p>
        <p className="my-6 leading-relaxed">
          You could literally read the entire thing, implement everything, start making money, and still ask for a refund.
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
          So here's the deal: You have absolutely nothing to lose and everything to gain.
        </h2>
        <p className="my-6 leading-relaxed">
        ...
        <ul className="list-disc list-inside ml-4 my-6">
          <li><span className="font-bold">Your colleagues</span> are going about their day, complaining about their salaries, worrying about next month's expenses, and doing absolutely nothing to change their situation.</li>
          <li><span className="font-bold">Your friends</span> are scrolling through social media, looking at other people's success stories, and wishing they could have that life too.</li>
          <li><span className="font-bold">Your neighbors</span> are having the same conversations they had last year: "If only I had more money..." "If only I could start a business..." "If only things were different..."</li>
        </ul>
        <p className="my-6 leading-relaxed">
          But you? You're different.
        </p>
        <ul className="list-disc list-inside ml-4 my-6">
          <li><span className="font-bold">You're here</span>, reading this, because something inside you refuses to accept mediocrity.</li>
          <li><span className="font-bold">You're not like the 97%</span> of Nigerians who will read something like this and do nothing.</li>
          <li><span className="font-bold">You're part of the 3%</span> who actually take action when opportunity presents itself.</li>
        </ul>
        <p className="my-6 leading-relaxed">
          Here's what separates successful people from everyone else: When they see a proven system that could change their life, they don't hesitate.
        </p>
        <p className="my-6 leading-relaxed">
          They don't overthink it. They don't wait for the "perfect time."
        </p>
        <p className="my-6 leading-relaxed">
          They act.
        </p>
        ...
        <p className="my-6 leading-relaxed">
          <span className="font-bold">❌</span> You can close this page and go back to your normal routine.
        </p>
        <p className="my-6 leading-relaxed">
          Wake up tomorrow, go to work, collect your salary, struggle through another month, and hope things magically get better.
        </p>
        <p className="my-6 leading-relaxed">
          <span className="font-bold">✔</span> Or you can be the person who does what others won't do today, so you can have what others can't have tomorrow.
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8 text-red-600 border-2 border-gray-300 p-4">
          But here's the brutal truth most people don't want to face...
        </h2>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          <span className="font-bold">❌</span> Most people take forever to decide and then change their minds quickly.
        </p>
        <p className="my-6 leading-relaxed">
          <span className="font-bold">✔</span> Successful people decide quickly and rarely change their minds.
        </p>
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8">
        ...
        <p className="my-6 leading-relaxed">
          Who understands that ₦5,250 invested today could generate ₦600,000+ this year?
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          So the question isn't whether this system will work for you.
        </p>
        <p className="my-6 leading-relaxed">
          The question is whether you're ready to do what it takes to make it work.
        </p>
        <p className="my-6 leading-relaxed">
          Because I'll be honest with you... this playbook isn't for everyone.
        </p>
        <ul className="list-disc list-inside ml-4 my-6">
          <li><span className="font-bold">❌</span> It's not for people who want to get rich overnight without working.</li>
          <li><span className="font-bold">❌</span> It's not for people who make excuses instead of taking action.</li>
          <li><span className="font-bold">❌</span> It's not for people who blame everyone else for their problems.</li>
        </ul>
        <p className="my-6 leading-relaxed">
          But..
        </p>
        <ul className="list-disc list-inside ml-4 my-6">
          <li><span className="font-bold">✔</span> If you're someone who's ready to take control of your financial future...</li>
          <li><span className="font-bold">✔</span> If you're tired of living paycheck to paycheck...</li>
          <li><span className="font-bold">✔</span> If you're ready to build something meaningful that could change your family's destiny...</li>
        </ul>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          <span className="font-bold">OPTION 1: Direct Bank Transfer (Most Popular)</span>
        </p>
        <p className="my-6 leading-relaxed">
          This is the fastest way for most people to get started:
        </p>
        <ul className="list-disc list-inside ml-4 my-6">
        ...
        <p className="my-6 leading-relaxed">
          That's it! Simple, secure, and you're dealing directly with us.
        </p>
        <p className="my-6 leading-relaxed">
          <span className="font-bold">OPTION 2: Paystack Payment (Cards, USSD, Mobile Money)</span>
        </p>
        <p className="my-6 leading-relaxed">
          If you prefer to pay with your ATM card, USSD, or mobile money, we use Paystack - Nigeria's most trusted payment platform (the same system used by Flutterwave, Jumia, and other major companies).
        </p>
        <p className="my-6 leading-relaxed">
        ...
        <ul className="list-disc list-inside ml-4 my-6">
          ...
          <li>Choose your preferred method → Pay with whatever is most convenient for you</li>
          <li>Complete payment → Paystack automatically redirects you to your download page</li>
          <li>Download immediately → Your playbook is ready instantly</li>
        </ul>
        <p className="my-6 leading-relaxed">
          The whole process takes less than 2 minutes, and Paystack handles everything securely.
        </p>
        <p className="my-6 leading-relaxed">
          You don't need to send emails or wait for manual processing - it's completely automated.
        </p>
        <p className="my-6 leading-relaxed">
          <span className="font-bold">Choose Your Payment Method Below:</span>
        </p>
        <p className="my-6 leading-relaxed">
          <a href="#" className="underline text-blue-600 hover:text-blue-800">[GET INSTANT ACCESS VIA PAYSTACK - ₦5,250]</a>
        </p>
        <p className="my-6 leading-relaxed">
          Most convenient - Download immediately after payment
        </p>
        <p className="my-6 leading-relaxed">
          OR
        </p>
        ...
        <h2 className="text-center font-bold text-2xl sm:text-3xl my-8 text-red-600 border-2 border-gray-300 p-4">
          The only question is: Will you be the person who took action today and changed their life?
        </h2>
        <p className="my-6 leading-relaxed">
        ...
        <p className="my-6 leading-relaxed">
          P.S. - If you skipped straight to the bottom, here's what you need to know:
        </p>
        <p className="my-6 leading-relaxed">
          For just ₦5,250 (less than what you spend on lunch this week), you get the complete step-by-step system that shows employed Nigerians how to build ₦50,000-₦200,000 monthly side businesses without risking their jobs or savings.
        </p>
        <p className="my-6 leading-relaxed">
          60-day money-back guarantee means you literally cannot lose.
        </p>
        <p className="my-6 leading-relaxed">
          <a href="#" className="underline text-blue-600 hover:text-blue-800">[Click here to get instant access now]</a>
        </p>
      </section>
    </main>
  );
