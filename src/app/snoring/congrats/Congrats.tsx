...
export default function Congrats() {
  ...
  const verifyPayment = async (ref: string) => {
    try {
      ...
      if (response.data.status === 'success') {
        const downloadResponse = await axios.get('/api/get-snoring-download-url');
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = 'Stop Your Husband From Snoring in 7 Days.pdf';
        ...
        {status === 'verifying' && (
          <>
            ...
            <p className="text-lg text-gray-700 mb-6">
              Please wait while we verify your "Stop Your Husband From Snoring in 7 Days" payment...
            </p>
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-lg text-gray-700 mb-4">
              You've secured <span className="font-bold">The "Stop Your Husband From Snoring in 7 Days"</span> for ₦2,499! You're now ready to transform your bedroom into a haven of peaceful nights
            </p>
            <p className="text-lg text-gray-700 mb-6">
              <span className="font-bold">Your eBook is ready!</span> Click below to download The "Stop Your Husband From Snoring in 7 Days" guide instantly. Have issues? Contact <a href="mailto:thecashologists00@gmail.com" className="text-blue-600 underline">thecashologists00@gmail.com</a>.
            </p>
            <div className="bg-green-50 border-2 border-green-500 rounded-lg p-4 mb-6">
              <p className="text-lg text-gray-700 font-semibold">
                Start your journey now—unlock the secrets to having peaceful and enjoyable sleep!
              </p>
            </div>
            <button
            ...
            <p className="text-sm text-gray-600 mt-6">
              We're thrilled to have you on board! Your bedroom success story starts today. Questions? Contact <a href="mailto:thecashologists00@gmail.com" className="text-blue-600 underline">thecashologists00@gmail.com</a>.
            </p>
          </>
        )}
