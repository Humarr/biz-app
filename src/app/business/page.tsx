  ...
  return (
    <main className="bg-background text-primary font-body">
      ...
      <section className="max-w-3xl mx-auto px-4 space-y-6">
        ...
        <p>Your <span className="font-bold">confidence.</span> Your <span className="font-bold">hope.</span> Your <span className="font-bold">family's belief in you.</span></p>
      </section>
      ...
      {/* Call to Action */}
      <section className="bg-primary text-white px-4 py-12 text-center space-y-6">
