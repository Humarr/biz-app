  ...
  return (
    <main className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8 font-sans bg-background min-h-screen">
      ...
      <section className="py-8 md:py-12 text-center">
        {/* <div className='bg-accent w-full p-4 mb-8'>

        <p className="text-white text-2xl sm:text-xl md:text-2xl font-bold font-scribble">
          Are you ready to Stop Guessing and Start Winning?
        </p>
        </div> */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 ">
          Are you Ready For the "Little Known" Secret...
          
          <span className="font-normal font-scribble">That Will Show Why 90% of Nigerians Stay Broke — Even After "Starting a Business."?</span>
        </h2>
      ...
      <section className="mb-10 md:mb-14 text-center">
        <div className="bg-red-50 p-6 rounded-lg border-l-8 border-red-600 max-w-2xl mx-auto">
          ...
          <p className="text-lg sm:text-xl">
            Stop spinning the business roulette wheel blindfolded. Learn what smart entrepreneurs know — before you join the <span className="font-scribble">90% graveyard.</span>
          </p>
        </div>
      </section>
